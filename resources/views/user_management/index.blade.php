                ...
                <div class="accordion" id="createUserCollapseParent">
                    <div class="card card_gbr card_ofh shadow-none p-0 card_body_bg_gray">
                        ...
                        <div id="createUserCollapseDiv" class="collapse show cb_t0b15x25" aria-labelledby="createUserCollapseHeading" data-parent="#createUserCollapseParent">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <span class="cust_info_txtwicon"><i class="nc-icon nc-alert-circle-i font-weight-bold" aria-hidden="true"></i> The system will automatically generate a unique password for this user and will notify the person thru <span id="displayHisHerText">his/her</span> registered Gmail account.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion" id="listRegisteredUsersCollapseParent">
                            <div class="card card_gbr card_ofh shadow-none p-0 card_body_bg_gray">
                                ...
                                <div id="listRegisteredUsersCollapseDiv" class="collapse show cb_t0b15x25" aria-labelledby="listRegisteredUsersCollapseHeading" data-parent="#listRegisteredUsersCollapseParent">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <span class="cust_status_title">Active Users <i class="nc-icon nc-alert-circle-i cust_info_icon" data-toggle="tooltip" data-placement="top" title="Active Users are registered users who can access the system according to their system roles."></i></span>
                                        </div>
                                    </div>
                                    ...
                                    @if(count($deactivated_users) > 0)
                                        <div class="row mt-4">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <span class="cust_status_title">Deactivated Users <i class="nc-icon nc-alert-circle-i cust_info_icon" data-toggle="tooltip" data-placement="top" title="Deactivated Users are users where status' have been deactivated and are no longer be able to access the system until activation."></i></span>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    @if(count($pending_users) > 0)
                                        <div class="row mt-4">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <span class="cust_status_title">Pending Users <i class="nc-icon nc-alert-circle-i cust_info_icon" data-toggle="tooltip" data-placement="top" title="Pending Users are users that have not yet been assigned a role and are newly registered accounts."></i></span>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <span class="cust_info_txtwicon"><i class="nc-icon nc-tap-01" aria-hidden="true"></i> {{ count($pending_users) }} Pending @if(count($pending_users) > 1) Users @else User @endif found.</span>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <span class="cust_info_txtwicon font-weight-bold"><i class="nc-icon nc-bullet-list-67" aria-hidden="true"></i> {{ count($registered_users) }} Registered @if(count($registered_users) > 1) Users @else User @endif found.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion" id="listUserRolesCollapseParent">
                            <div class="card card_gbr card_ofh shadow-none p-0 card_body_bg_gray">
                                ...
                                <div id="listUserRolesCollapseDiv" class="collapse show cb_t0b15x25" aria-labelledby="listUserRolesCollapseHeading" data-parent="#listUserRolesCollapseParent">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <span class="cust_status_title">Active Roles <i class="nc-icon nc-alert-circle-i cust_info_icon" data-toggle="tooltip" data-placement="top" title="Roles are assigned to specific users for access controls."></i></span>
                                        </div>
                                    </div>
                                    @if(count($active_roles) > 0)
                                    <div class="row mt-2">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="accordion shadow cust_accordion_div" id="uRolesAccordion_Parent">
                                                ...
                                                <div class="card custom_accordion_card">
                                                    <div class="card-header p-0" id="userRoleCollapse_heading{{$active_role->uRole_id}}">
                                                        <h2 class="mb-0">
                                                        <button class="btn btn-link btn-block custom2_btn_collapse d-flex justify-content-between align-items-center" type="button" data-toggle="collapse" data-target="#uRoleCollapse_Div{{$active_role->uRole_id}}" aria-expanded="true" aria-controls="uRoleCollapse_Div{{$active_role->uRole_id}}">
                                                            <div>
                                                    ...
                                                    <div id="uRoleCollapse_Div{{$active_role->uRole_id}}" class="collapse cb_t0b12y20" aria-labelledby="userRoleCollapse_heading{{$active_role->uRole_id}}" data-parent="#uRolesAccordion_Parent">
                                                    ...
                                                    {{-- else --}}
                                                        ...
                                                        <div class="card-body p-0">
                                                            <ul class="nav nav-pills custom_nav_pills mt-0 mb-3 d-flex justify-content-center" id="uRoleOptions_tabList" role="tablist">
                                                                <li class="nav-item">
                                                                    <a class="nav-link @if($active_role->uRole_type === 'student') custom_nav_link_green @else custom_nav_link_blue @endif active" id="previewUserRoleTab" data-toggle="pill" href="#previewUserRoleLink" role="tab" aria-controls="previewUserRoleLink" aria-selected="true">Preview</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link @if($active_role->uRole_type === 'student') custom_nav_link_green @else custom_nav_link_blue @endif" id="editUserRoleTab" data-toggle="pill" href="#editUserRoleLink" role="tab" aria-controls="editUserRoleLink" aria-selected="false">Edit Role</a>
                                                                </li>
                                                            </ul>
                                                            <div class="tab-content">
                                                                {{-- PREVIEW ROLE --}}
                                                                <div class="tab-pane fade show active" id="previewUserRoleLink" role="tabpanel" aria-labelledby="previewUserRoleTab">
                                                                    <div class="card-body lightBlue_cardBody">
                                                                    @if(count($assigned_users) > 0)
                                                                ...
                                                                {{-- EDIT ROLE --}}
                                                                <div class="tab-pane fade" id="editUserRoleLink" role="tabpanel" aria-labelledby="editUserRoleTab">
                                                                        ...
                                                                        <div class="card-body lightGreen_cardBody mt-2">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="custom-control custom-checkbox align-items-center">
                                                                                    <input type="checkbox" name="edit_uRole_access[]" class="custom-control-input cursor_pointer" id="profileModCheck" @if(!is_null($active_role->uRole_access)) @if(in_array('profile', $make_array_uRole_access)) checked @endif @endif>
                                                                                    <label class="custom-control-label lightGreen_cardBody_chckboxLabel" for="profileModCheck">Profile</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <div class="custom-control custom-checkbox align-items-center">
                                                                                    <input type="checkbox" name="edit_uRole_access[]" class="custom-control-input cursor_pointer" id="dashboardModCheck" @if(!is_null($active_role->uRole_access)) @if(in_array('dashboard', $make_array_uRole_access)) checked @endif @endif>
                                                                                    <label class="custom-control-label lightGreen_cardBody_chckboxLabel" for="dashboardModCheck">Dashboard</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <div class="custom-control custom-checkbox align-items-center">
                                                                                    <input type="checkbox" name="edit_uRole_access[]" class="custom-control-input cursor_pointer" id="user_managementModCheck" @if(!is_null($active_role->uRole_access)) @if(in_array('user management', $make_array_uRole_access)) checked @endif @endif>
                                                                                    <label class="custom-control-label lightGreen_cardBody_chckboxLabel" for="user_managementModCheck">User Management</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <div class="custom-control custom-checkbox align-items-center">
                                                                                    <input type="checkbox" name="edit_uRole_access[]" class="custom-control-input cursor_pointer" id="violation_entryModCheck" @if(!is_null($active_role->uRole_access)) @if(in_array('violation entry', $make_array_uRole_access)) checked @endif @endif>
                                                                                    <label class="custom-control-label lightGreen_cardBody_chckboxLabel" for="violation_entryModCheck">Violation Entry</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <div class="custom-control custom-checkbox align-items-center">
                                                                                    <input type="checkbox" name="edit_uRole_access[]" class="custom-control-input cursor_pointer" id="violation_recordsModCheck" @if(!is_null($active_role->uRole_access)) @if(in_array('violation records', $make_array_uRole_access)) checked @endif @endif>
                                                                                    <label class="custom-control-label lightGreen_cardBody_chckboxLabel" for="violation_recordsModCheck">Violation Records</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <div class="custom-control custom-checkbox align-items-center">
                                                                                    <input type="checkbox" name="edit_uRole_access[]" class="custom-control-input cursor_pointer" id="student_handbookModCheck" @if(!is_null($active_role->uRole_access)) @if(in_array('student handbook', $make_array_uRole_access)) checked @endif @endif>
                                                                                    <label class="custom-control-label lightGreen_cardBody_chckboxLabel" for="student_handbookModCheck">Student Handbook</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </form>
