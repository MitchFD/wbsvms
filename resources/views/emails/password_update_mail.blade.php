...
<body>
    ...
    <p>This email is to notify you that the system Administrator of the Student Violation Management System has updated your password for the following reason/s:</p>
