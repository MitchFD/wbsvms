...
class CreateDeletedStudentUsersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deleted_student_users_tbl', function (Blueprint $table) {
            $table->id('del_id');
            ...
            $table->string('del_uStud_school')->nullable();    
            $table->string('del_uStud_program')->nullable();    
            $table->string('del_uStud_yearlvl')->nullable();    
            $table->string('del_uStud_section')->nullable();    
            $table->unsignedBigInteger('del_uStud_phnum')->nullable();  
    ...
    {
        Schema::dropIfExists('deleted_student_users_tbl');
    }
}
